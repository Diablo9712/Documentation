        ...
        <li class="header">MAIN NAVIGATION</li>
         ...
         <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<%=request.getContextPath()%>/DemandeProfesseur" ><i class="fa fa-circle-o"></i> Liste Demandes</a></li>
          </ul>
        </li>
          ...
          <ul class="treeview-menu">
                ...
                <li><a href="<%=request.getContextPath()%>/DocumentDemanderProfesseur" ><i class="fa fa-circle-o"></i> Liste Documents Demander</a></li>
          </ul>
        </li>
