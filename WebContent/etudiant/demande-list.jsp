 ...
 <%@ include file="header.jsp" %>
  ...
  <div class="content-wrapper">
	...
	<div class="row"style="overflow-x:auto;">
				<div class="container" >
					<h3 class="text-center">Gestion des Demandes</h3>
					<hr>
  ...
  <tbody>
	...
	ResultSet rs = null;
	cn = DB.getConnection();
		String sql = "select demande.id as id,demande.date_demande as date,demande.etat as etat,concat(users.first_name,' ',users.last_name) as fullname,document.name from users,document,account,demande where users.id = demande.user and account.permission = 'etudiant' and demande.document = document.id and users.id =   "+nd;
		...
		%>
							...
							<td>
								<a href="deletedeetudiant?id=<%=rs.getInt(1) %>" class="btn btn-danger">Delete</a>
								</td>
							</tr>
							<%} %>
              ...
              <div class="card card-primary">
				<div class="row">
						...
						<div class="card-body" style="margin-left:10%;margin-right:10%">
									...
									<form action="insertdetudiant" method="post" >
