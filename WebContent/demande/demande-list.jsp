...
bottom: .5em;
 ...
 <%@ include file="header.jsp" %>
  ...
  <tbody>
	...
	ResultSet rs = null;
	cn = DB.getConnection();
		String sql = "select demande.id as id,demande.date_demande as date,demande.etat as etat,concat(users.first_name,' ',users.last_name) as fullname,document.name from users,document,demande where users.id = demande.user and demande.document = document.id  ";
		...
		%>
							...
							<td>
								<a href="deletede?id=<%=rs.getInt(1) %>" class="btn btn-danger">Delete</a>
								</td>
							</tr>
							<%} %>
              ...
              <div class="card card-primary">
				<div class="row">
						...
						<div class="card-body" style="margin-left:10%;margin-right:10%">
									...
									<form action="insertde" method="post" >
