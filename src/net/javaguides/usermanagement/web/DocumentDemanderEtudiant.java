...
/**
 * Servlet implementation class DocumentDemanderEtudiant
 */
@WebServlet( name = "DocumentDemanderEtudiant", urlPatterns = {"/DocumentDemanderEtudiant"})

public class DocumentDemanderEtudiant extends HttpServlet {
     ...
     */
    public DocumentDemanderEtudiant() {
        super();
